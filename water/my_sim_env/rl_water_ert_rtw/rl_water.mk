###########################################################################
## Makefile generated for component 'rl_water'. 
## 
## Makefile     : rl_water.mk
## Generated on : Tue Jun 30 00:54:02 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/rl_water.exe
...
PRODUCT_NAME              = rl_water
MAKEFILE                  = rl_water.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/6_PHD_Research_Group/10_Python_Code/GOPS_Hang/water/my_sim_env
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = rl_water_comp.rsp
CMD_FILE                  = rl_water.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/rl_water.exe
...
DEFINES_STANDARD = -DMODEL=rl_water -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/rl_water_ert_rtw/rl_water.cpp $(START_DIR)/rl_water_ert_rtw/rtGetInf.cpp $(START_DIR)/rl_water_ert_rtw/rt_nonfinite.cpp
...
OBJS = rl_water.obj rtGetInf.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/rl_water_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/rl_water_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/rl_water_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/rl_water_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/rl_water_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rl_water.obj : $(START_DIR)/rl_water_ert_rtw/rl_water.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/rl_water_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/rl_water_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
