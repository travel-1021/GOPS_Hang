...
XDis_rl_water_T* rl_water::RT_MODEL_rl_water_T::getContStateDisabled() const
{
...
X_rl_water_T* rl_water::RT_MODEL_rl_water_T::getContStates() const
{
  return contStates;
}
...
const odeFSubArray* rl_water::RT_MODEL_rl_water_T::getOdeF() const
{
  return odeF;
}
